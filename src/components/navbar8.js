  ...
  return (
    <header className="navbar8-container">
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        ...
        />
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu"></div>
          ...
          <div className="navbar8-nav">
            ...
            <nav className="navbar8-links">
              ...
              <a href={props.link2Url}>
                {props.link2 ?? (
                  <Fragment>
                    <span className="navbar8-text04 thq-link thq-body-small">
                      Link 2
                    </span>
                  </Fragment>
                )}
                        ...
                        <div className="navbar8-content3">
                          ...
                          <span>
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text02 thq-body-small">
            ...
            <div className="navbar8-buttons">
              <button className="thq-button-filled">
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar8-text03">Main Action</span>
                    </Fragment>
                  )}
                </span>
              </button>
